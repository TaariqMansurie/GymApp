import 'package:GymApp/Screens/Payment/razorpay_payment_platinumFemale.dart';
import 'package:flutter/material.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:google_fonts/google_fonts.dart';

//for platinum female
class PackageDetails22 extends StatefulWidget {
  var name = '' ;
  var price1 ;
  var price2 ;
  var price3 ;
  PackageDetails22(this.name,this.price1,this.price2,this.price3);

  @override
  _PackageDetails22State createState() => _PackageDetails22State();
}

class _PackageDetails22State extends State<PackageDetails22> {
                              ...
                              if(selectedPrice == '8300' && selectedPackageDuration == '1 Month')
                              {
                                Navigator.push((context),
                                    MaterialPageRoute(builder: (context){
                                      return RazorpayPaymentPlatinumFemale(
