...
class SuperTransformation5 extends StatelessWidget {
              ...
              slivers: [
                SliverAppBar(
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                      background: Image.asset('assets/videos/18.png',fit: BoxFit.fitHeight) == null ? Center(child: CircularProgressIndicator()) : InteractiveViewer(
                          boundaryMargin: const EdgeInsets.all(double.infinity),
                          minScale: 1.0,
                          maxScale: 5.0,
                          child: Image.asset('assets/videos/18.png',fit: BoxFit.fitHeight))
                  ),
                ),
