...
class SuperTransformation6 extends StatefulWidget {
  ...
  SuperTransformation6(this.name,this.achievement,this.certification,this.specialization,this.exp,this.profilepic,this.doc);

  @override
  _SuperTransformation6State createState() => _SuperTransformation6State();
}

class _SuperTransformation6State extends State<SuperTransformation6> {
