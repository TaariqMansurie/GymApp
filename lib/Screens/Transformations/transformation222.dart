...
import 'package:GymApp/Screens/Packages/packageDetailsFemale2.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class SuperTransformation222 extends StatefulWidget {
  var name ;
  var achievement ;
  var certification ;
  var specialization ;
  ...
  var price2 ;
  var price3 ;
  SuperTransformation222(this.name,this.achievement,this.certification,this.specialization,this.exp,this.profilepic,this.doc,this.price1,this.price2,this.price3);

  @override
  _SuperTransformation222State createState() => _SuperTransformation222State();
}

class _SuperTransformation222State extends State<SuperTransformation222> {
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: (){ Navigator.push(
                          context, MaterialPageRoute(
                            builder: (context) => PackageDetails22(widget.name,widget.price1,widget.price2,widget.price3)),
                        );},),
                    ),
