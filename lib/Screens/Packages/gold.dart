import 'package:GymApp/Screens/Transformations/transformation22.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class GoldPackagee extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: new AppBar(
        ...
        elevation: 0.0,
        title: new Text(" Gold Package ",style: TextStyle(
                                  ...
                                  onTap: (){
                                    ...
                                    Navigator.push(
                                      context, MaterialPageRoute(
                                        builder: (context) => SuperTransformation22(name,achievement,certification,specialization,exp,profilepic,doc,price1,price2,price3)),
                                    );
                                  },
