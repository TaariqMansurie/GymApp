...
import 'package:GymApp/Screens/Packages/pakageDetails4.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class SuperTransformation33 extends StatefulWidget {
  var name ;
  var achievement ;
  var certification ;
  var specialization ;
  ...
  var price2 ;
  var price3 ;
  SuperTransformation33(this.name,this.achievement,this.certification,this.specialization,this.exp,this.profilepic,this.doc,this.price1,this.price2,this.price3);

  @override
  _SuperTransformation33State createState() => _SuperTransformation33State();
}

class _SuperTransformation33State extends State<SuperTransformation33> {
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: (){ Navigator.push(
                          context, MaterialPageRoute(
                            builder: (context) => PackageDetails4(widget.name,widget.price1,widget.price2,widget.price3)),
                        );},),
                    ),
