...
import 'package:GymApp/Widgets/custom_input_field_with_hint.dart';
import 'package:GymApp/Widgets/custom_input_field_with_hint2.dart';
import 'package:GymApp/Widgets/custom_input_field_with_hint7.dart';
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Image(
                      image: AssetImage('assets/gifs/zz.png'),
                      height: 141,
                      width: 146,
                    )
                  ],
                          ...
                          onTap: () {
                            if (_formKey.currentState.validate()) {
                              Map<String, String> personalDetail = {
                                 ...
                                 'Contact No': contactNo.text.toString(),
                                ...
                                Navigator.push((context),
                                    MaterialPageRoute(builder: (context){
                                      return TrainersForm2(
                                          firstName,lastName,selectedGender,contactNo,
