...
//for silver
class RazorpayPaymentGold extends StatefulWidget {
  ...
  RazorpayPaymentGold(this.selectedPrice,this.selectedPackageType,this.selectedPackageDuration,this.name);

  @override
  _RazorpayPaymentGoldState createState() => _RazorpayPaymentGoldState();
}

class _RazorpayPaymentGoldState extends State<RazorpayPaymentGold> {
  Razorpay razorpay ;
  ...
  void handlerPaymentSuccess(PaymentSuccessResponse response) {
    ...
    reff.setData({
      ...
      'payment_amount' : widget.selectedPrice.toString(),
    },merge: true);
