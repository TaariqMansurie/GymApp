...
class SuperTransformation2 extends StatefulWidget {
  var name ;
  var achievement ;
  var certification ;
  var specialization ;
  ...
  var price2 ;
  var price3 ;
  SuperTransformation2(this.name,this.achievement,this.certification,this.specialization,this.exp,this.profilepic,this.doc,this.price1,this.price2,this.price3);

  @override
  _SuperTransformation2State createState() => _SuperTransformation2State();
}

class _SuperTransformation2State extends State<SuperTransformation2> {
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: (){ Navigator.push(
                          context, MaterialPageRoute(
                            builder: (context) => PackageDetails2(widget.name,widget.price1,widget.price2,widget.price3)),
                        );},),
                    ),
