...
//for silver
class RazorpayPaymentGoldFemale extends StatefulWidget {
  ...
  RazorpayPaymentGoldFemale(this.selectedPrice,this.selectedPackageType,this.selectedPackageDuration,this.name);

  @override
  _RazorpayPaymentGoldFemaleState createState() => _RazorpayPaymentGoldFemaleState();
}

class _RazorpayPaymentGoldFemaleState extends State<RazorpayPaymentGoldFemale> {
  Razorpay razorpay ;
