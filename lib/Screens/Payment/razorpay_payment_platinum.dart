...
//for silver
class RazorpayPaymentPlatinum extends StatefulWidget {
  ...
  RazorpayPaymentPlatinum(this.selectedPrice,this.selectedPackageType,this.selectedPackageDuration,this.name);

  @override
  _RazorpayPaymentPlatinumState createState() => _RazorpayPaymentPlatinumState();
}

class _RazorpayPaymentPlatinumState extends State<RazorpayPaymentPlatinum> {
  Razorpay razorpay ;
