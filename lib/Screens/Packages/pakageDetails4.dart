import 'package:GymApp/Screens/Payment/razorpay_payment_platinum.dart';
...
//for platinum male
class PackageDetails4 extends StatefulWidget {
  var name = '' ;
  var price1 ;
  var price2 ;
  var price3 ;
  PackageDetails4(this.name,this.price1,this.price2,this.price3);

  @override
  _PackageDetails4State createState() => _PackageDetails4State();
}

class _PackageDetails4State extends State<PackageDetails4> {
  ...
  var selectedPrice ;
  final List<String> packagePricing = ['10300','28300','58300'];
                        ...
                        child: GestureDetector(
                          onTap: () {
                            if (_formKeyy.currentState.validate()) {
                              ...
                              if(selectedPrice == '10300' && selectedPackageDuration == '1 Month')
                              {
                                Navigator.push((context),
                                    MaterialPageRoute(builder: (context){
                                      return RazorpayPaymentPlatinum(
                                          selectedPrice,selectedPackageType,selectedPackageDuration,widget.name
                                      );
                                    }));
                              }else if (selectedPrice == '28300' && selectedPackageDuration == '3 Months')
                              {
                                Navigator.push((context),
                                    MaterialPageRoute(builder: (context){
                                      return RazorpayPaymentPlatinum(
                              ...
                              else if (selectedPrice == '58300' && (selectedPackageDuration == '6 Months'))
                              {
                                Navigator.push((context),
                                    MaterialPageRoute(builder: (context){
                                      return RazorpayPaymentPlatinum(
