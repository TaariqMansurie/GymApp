...
class SuperTransformation1 extends StatefulWidget {
  ...
  SuperTransformation1(this.name,this.achievement,this.certification,this.specialization,this.exp,this.profilepic,this.doc,this.price1,this.price2,this.price3);

  @override
  _SuperTransformation1State createState() => _SuperTransformation1State();
}

class _SuperTransformation1State extends State<SuperTransformation1> {
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: (){ Navigator.push(
                        context, MaterialPageRoute(
                          builder: (context) => PackageDetails(widget.name,widget.price1,widget.price2,widget.price3)),
                      );},),
                  ),
