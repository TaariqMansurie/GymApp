...
class TOTWFemale extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: new AppBar(
        ...
        elevation: 0.0,
        title: new Text(" TOTW ",style: TextStyle(
                          ...
                          child: Container(
                            ...
                            child: Scrollbar(
                              ...
                              child: ListView.builder(shrinkWrap: true,physics: NeverScrollableScrollPhysics(),itemBuilder: (context, index) {
                                ...
                                final String profilepic = snapshot.data.documents[index]['starTrainerProfileFemale'];
                                ...
                                return exp == '4+ Years' && gender == 'FEMALE'? Card(
                                  child: ListTile(
                                    onTap: (){
                          ...
                          child: Container(
                            ...
                            child: Scrollbar(
                              ...
                              child: ListView.builder(shrinkWrap: true,physics: NeverScrollableScrollPhysics(),itemBuilder: (context, index) {
                                ...
                                return exp == '8+ Years' && gender == 'FEMALE' ? Card(
                                  child: ListTile(
                                    onTap: (){
                                      print('trainer\'s profile');
                                      Navigator.push(
