...
class GoldFemale extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: new AppBar(
        ...
        elevation: 0.0,
        title: new Text(" Gold Female Package",style: TextStyle(
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('Click below to view trainer\'s profile',
                                  ...
                                  onTap: (){
                                    ...
                                    Navigator.push(
                                      context, MaterialPageRoute(
                                        builder: (context) => SuperTransformation2(name,achievement,certification,specialization,exp,profilepic,doc,price1,price2,price3)),
                                    );
                                  },
