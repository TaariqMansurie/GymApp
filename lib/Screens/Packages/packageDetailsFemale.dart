import 'package:GymApp/Screens/Payment/razorpay_payment_goldFemale.dart';
...
class PackageDetails2 extends StatefulWidget {
  ...
  var price2 ;
  var price3 ;
  PackageDetails2(this.name,this.price1,this.price2,this.price3);

  @override
  _PackageDetails2State createState() => _PackageDetails2State();
}
...
class _PackageDetails2State extends State<PackageDetails2> {
  ...
  var selectedPrice  ;
  final List<String> packagePricing = ['6300','16300','30300'];
                        ...
                        child: GestureDetector(
                          onTap: () {
                            if (_formKeyy.currentState.validate()) {
                              ...
                              if(selectedPrice == '6300' && selectedPackageDuration == '1 Month')
                              {
                                Navigator.push((context),
                                    MaterialPageRoute(builder: (context){
                                      return RazorpayPaymentGoldFemale(
                                          selectedPrice,selectedPackageType,selectedPackageDuration,widget.name
                                      );
                                    }));
                              }else if (selectedPrice == '16300' && selectedPackageDuration == '3 Months')
                              {
                                Navigator.push((context),
                                    MaterialPageRoute(builder: (context){
                                      return RazorpayPaymentGoldFemale(
                              ...
                              else if (selectedPrice == '30300' && (selectedPackageDuration == '6 Months'))
                              {
                                Navigator.push((context),
                                    MaterialPageRoute(builder: (context){
                                      return RazorpayPaymentGoldFemale(
