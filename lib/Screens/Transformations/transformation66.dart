...
class SuperTransformation66 extends StatefulWidget {
  ...
  SuperTransformation66(this.name,this.achievement,this.certification,this.specialization,this.exp,this.profilepic,this.doc);

  @override
  _SuperTransformation66State createState() => _SuperTransformation66State();
}

class _SuperTransformation66State extends State<SuperTransformation66> {
