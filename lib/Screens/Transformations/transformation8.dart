...
//for femaletrainers
class SuperTransformation8 extends StatefulWidget {
  ...
  SuperTransformation8(this.name,this.achievement,this.certification,this.specialization,this.exp,this.profilepic,this.doc);

  @override
  _SuperTransformation8State createState() => _SuperTransformation8State();
}

class _SuperTransformation8State extends State<SuperTransformation8> {
              ...
              slivers: [
                ...
                SliverFixedExtentList(
                  ...
                  delegate: SliverChildListDelegate([
                    ...
                    //         builder: (context) => PackageDetails22(widget.name,widget.price1,)),
                    //     );},),
                    // ),
